...
rl.question('What domain should we use? ', function (domain) {
    ...
    fs.readFile(appRoot + '/templates/component.jsx', 'utf8', function (err,data) {
      if (err) {
      ...
      fs.readFile(appRoot + '/templates/store.js', 'utf8', function (err,data) {
        ...
        // Writing store file
        fs.writeFile('flux/stores/' + domain + '/' + component + 'Store.js', finalresult, function(err) {
          if(err) {
            return console.log(err);
          }
      ...
      fs.readFile(appRoot + '/templates/actions.js', 'utf8', function (err,data) {
        ...
        // Writing store file
        fs.writeFile('flux/actions/' + domain + '/' + component + 'Actions.js', actions, function(err) {
          if(err) {
            return console.log(err);
          }
          console.log('Created store file in ' + domain);
